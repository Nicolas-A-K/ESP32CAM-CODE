...
void configCamera() {
  ...
  config.frame_size = FRAMESIZE_SVGA; // SVGA = qualidade média com 30fps, XGA = boa qualidade 15fps, CIF = qualidade mais baixa 60fps
